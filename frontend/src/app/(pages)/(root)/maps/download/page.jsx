            ...
            <div className="grid gap-2.5">
                {downloadMaps.map(m => (
                  <div key={m.id} className="p-4 shadow-md flex justify-between items-center">
                    ...
                    <a className='border border-blue-800 rounded-md px-3 py-1.5 text-blue-800 font-semibold hover:bg-blue-800 hover:border-transparent hover:text-white duration-200' target='_blank' href={`${m.form}`}>View</a>
                  </div>
                ))}
            </div>
          </div>
