    ...
    <header ref={headerRef} className="fixed w-full bg-[#fff] z-50">
      ...
      <nav className="py-[25px]">
        <ContainerCenter className="flex justify-between lg:justify-normal items-center lg:items-stretch xl:items-center xl:gap-10 lg:flex-col xl:flex-row">
            <div onClick={MenuHandler} className="menu-open-btn bg-gray-300 lg:hidden px-3 py-2 cursor-pointer rounded-sm">
            <FaBarsStaggered className="text-2xl"/>
            </div>
          <div className="logo pb-5 self-end lg:self-start">
            <img className="w-[150px] md:w-[200px]" src={logo} alt="" />
          </div>
          <ul className={`${!menuOpen ? "left-[-800px]" : "left-0"} lg:left-0 flex lg:items-center lg:gap-5 lg:border-t-2 xl:border-none border-gray-300 lg:pt-3 pb-5 absolute lg:relative flex-col lg:flex-row bg-gray-800 lg:bg-transparent w-[80%] md:w-[50%] lg:w-auto h-[100vh] lg:h-auto top-0 duration-300`}>
            ...
            <li>
              <a className="px-4 lg:py-2 py-3 hover:bg-gray-700 lg:hover:bg-transparent duration-300 text-gray-200 lg:text-gray-700 font-semibold border-b-[1px] lg:border-none block border-gray-600" href="#">
                Home
              </a>
            </li>
            <li>
